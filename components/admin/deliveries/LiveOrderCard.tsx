  ...
  return (
    <div className="bg-[#1f1f21] border border-[#2e2e30] rounded-xl p-3 space-y-2 hover:border-[#f9671a]/30 transition-colors">
      ...
      <div className="flex items-center gap-1.5">
        <button onClick={()=> router.push(`/admin/messages`)} className="flex-1 py-1 rounded-lg bg-[#252527] text-zinc-400 text-[10px] hover:text-white transition-colors flex items-center justify-center gap-1">
          <Phone size={9} /> Call
        </button>
        <button onClick={()=> router.push(`/admin/call-logs/${order.id}`)} className="flex-1 py-1 rounded-lg border border-[#f9671a]/50 text-[#f9671a] text-[10px] hover:bg-[#f9671a]/10 transition-colors flex items-center justify-center gap-1">
