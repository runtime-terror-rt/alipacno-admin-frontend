  ...
  return (
    <div className="space-y-6 sm:space-y-8 animate-fadeIn pb-12">
      ...
      {isReconciliationOpen && (
        <div className="fixed inset-0 bg-black/10 backdrop-blur-sm z-50 flex items-center justify-center p-4 overflow-y-auto animate-fadeIn">
          <div className="relative w-full max-w-xl bg-[#1e1e20] rounded-3xl space-y-6 shadow-2xl">
            {/* Modal Header */}
            <div className="flex items-start justify-between bg-[#1A1A1C]">
              <div className="p-6">
                <PageHeader
