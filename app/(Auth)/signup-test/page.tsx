  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex items-center justify-center p-4 md:p-8 z-10">
        <div className="w-full max-w-[400px] md:max-w-[440px] lg:max-w-[550px] bg-[##26262680] border border-white/10 rounded-2xl p-6 md:p-7 lg:p-10 shadow-2xl my-4 md:my-0">
          ...
          <p className="text-center text-zinc-400 mt-6">
            ...
            <Link href="/login" className="text-[#F9671A] font-semibold hover:underline cursor-pointer transition-colors duration-300">
              Sign In
            </Link>{" "}
            Here
          </p>
